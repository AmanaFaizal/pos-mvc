...
public class CustomerController {
    ...
    public String SaveCustomer(CustomerModel customer) throws SQLException{
        ...
        PreparedStatement preparedStatement= connection.prepareStatement(query);
         ...
         preparedStatement.setString(2, customer.getCustitle());
    ...
    public CustomerModel getCustomer(String cusId) throws SQLException{
           Connection connection = DBConnection.getInstance().getConnection();
    ...
    public String updateCustomer(CustomerModel customerModel) throws SQLException{
         ...
         PreparedStatement preparedStatement= connection.prepareStatement(query);
         preparedStatement.setString(1, customerModel.getCustitle());
         preparedStatement.setString(2, customerModel.getCusname());
         preparedStatement.setString(3, customerModel.getCusdob());
         ...
         preparedStatement.setString(8, customerModel.getZip());
          preparedStatement.setString(9, customerModel.getCusId());
    ...
    public String deleteCustomer(String cusId) throws SQLException{
           Connection connection = DBConnection.getInstance().getConnection();
